...
def seed_productTags():
 ...
 Porcelain= ProductTag( id= 17,products_id=18 , tags_id=1 )
 potosiensis= ProductTag( id= 18,products_id=19, tags_id=4 )
 slackii= ProductTag( id= 19,products_id=20 , tags_id=4 )
 yuccaDo1713= ProductTag( id= 20,products_id=21 , tags_id=4 )
 nelumbifoliaxreniformis= ProductTag( id= 21,products_id=22 , tags_id=7 )
